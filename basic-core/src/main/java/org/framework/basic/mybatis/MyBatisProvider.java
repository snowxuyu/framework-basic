...
import org.framework.basic.mybatis.complexQuery.NoValueQueryParam;
import org.framework.basic.mybatis.complexQuery.WithValueQueryParam;
...
/*        if (null == t.getId()) {
            t.setId(new IdWorker(new Random().nextInt(1023)).nextId());
        }*/
...
//				logger.debug("========insertBatch field name:{},type:{},value:{}", fieldName, type, val);
    ...
    private SQL WHERE(T findParams, SQL sql, String operator)
