...
import org.framework.basic.server.netty.initializer.ChannelInitializerWrapper;
import org.framework.basic.server.netty.initializer.HttpChannelInitializer;
...
public class NettyServerBootstrap {
     ...
     * @throws Exception
     */
    public ServerBootstrap startup() {
        ...
        try {
            ...
            WebAppConfiguration webapp = new WebAppConfiguration()
                    ...
                    // 静态资源名称
                    //.setStaticResourcesFolder("/statics")
                    // 文件大小
